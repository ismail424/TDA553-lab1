...
public abstract class Vehicle extends Entity implements IVehicle, ITransportable {
    ...
    public boolean isEnigneRunning() {
    ...
    public void CheckIfMoving() throws IllegalStateException {
        if (currentSpeed > 0) {
            throw new IllegalStateException("Cannot preform action while moving");
        }
    }
