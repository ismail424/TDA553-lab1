...
public class VehicleLoadable {
    ...
    /**
     * @param vehicle Throws an IllegalStateException if the vehicle is already loaded.
     */
    ...
    /**
     * @param vehicle Throws an IllegalStateException if the vehicle is not close enough to the loadable.
     */
    ...
    /**
     * @param vehicle Loads a vehicle onto the platform.
     */
    ...
    /**
     * @param vehicle Unloads a vehicle from the platform. The vehicle must be placed close to the transport vehicle.
     */
